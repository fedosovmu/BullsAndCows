...
public class Menu {
    ...
    Menu () {
        ...
        Player playerA = SelectPlayer(1);
        Player playerB = SelectPlayer(2);
    ...
    Player SelectPlayer (int playerNumber) {
        while (true) {
            ...
            int mode = 1; System.out.println(mode); // <---------------------
            //int mode = in.nextInt();
            switch (mode) {
                case 1:
                    return new Player("Human" + playerNumber);
                case 2:
                case 3:
